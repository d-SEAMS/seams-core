...
//  Super cool C++11
  ...
  public:
    ...
    // Check for phase transitions
        void mightTrans(int nop, int typeI, int frameNumOne, int frameNumTwo, std::array<double,3> coordHigh, std::array<double,3> coordLow, std::string fileName, int nstep);
};
