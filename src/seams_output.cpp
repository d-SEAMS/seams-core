...
/********************************************/ /**
 *  Function for printing out ring info, for
 a monolayer
 ***********************************************/
...
for all the cages in bulk ice, for every frame, printing the RMSD per atom as
well
***********************************************/
...
/********************************************/ /**
*  Prints out a LAMMPS data file
for all the rings for a single frame, with some
default options. Only Oxygen
atoms are printed out. Bonds are inferred from the rings
vector of vectors
***********************************************/
...
/********************************************/ /**
*  Function for writing out the XYZ file
 of a particular cluster. The vector atoms contains the atom indices of the
atoms to be written out
***********************************************/
