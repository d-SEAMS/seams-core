...
// Gets c_ij and then classifies bond types according to the CHILL+ algorithm
molSys::PointCloud<molSys::Point<double>, double> reclassifyWater(
    molSys::PointCloud<molSys::Point<double>, double> *yCloud,
 ...
 *
 The recommended function for calculating the spherical-harmonics based complex
 vector is sph::spheriHarmo. This function uses the <a
 href="https://www.boost.org/">Boost</a> libraries.
  ### Changelog ###
...
// Lookup table for Q6
std::vector<std::complex<double>> lookupTableQ6Vec(
    std::array<double, 2> angles);
