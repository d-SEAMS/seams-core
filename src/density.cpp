 ...
 *  Initializes the number density. The binning dimension 
 is the z dimension
 ***********************************************/
void Density::initNumberZ(class CMolecularSystem &molSys, double binwidth,
                          int typeI, double xlo, double xhi, double ylo,
  ...
  if (z_length == 0.0) {
    z_length = molSys.parameter->boxz;
  }
 ...
 ***********************************************/
void Density::NumberSingleFrameZ(class CMolecularSystem &molSys,
                                 double binwidth, int typeI, double xlo,
