...
for frame=targetFrame,finalFrame,frameGap do
    ...
    resCloud=selectInSingleSlice(resCloud,true,sliceLowerLimits,sliceUpperLimits); 
    -- Select edge atoms in rings 
    resCloud=selectEdgeAtomsInRingsWithinSlice(rings,oCloud,resCloud,sliceLowerLimits,sliceUpperLimits,false);
end
