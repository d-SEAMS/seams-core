...
templateOFile="../templates/s2-clathrate/single-cage-O-only.lammpstrj" --- for the O atom reference system 
templateWatFile="../templates/s2-clathrate/single-cage-watOnly.lammpstrj" --- for the water reference template for the S2 clathrate