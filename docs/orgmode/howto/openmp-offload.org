...
# GPU nodes lack glibc-devel. Copy crt1.o crti.o crtn.o Scrt1.o
# from a login /usr/lib64 into elja-crt/ before sbatch.
export LIBRARY_PATH=$PWD/elja-crt
export CFLAGS="-B$PWD/elja-crt"
export CXXFLAGS="-B$PWD/elja-crt"
export LDFLAGS="-B$PWD/elja-crt"
