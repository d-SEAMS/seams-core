...
# nvc++ 22.3 accepts -mp=gpu. Meson does not list C++20 for that
# release, so setup uses -Dcpp_std=none and -std=c++17.
export CC=$EB/GCCcore/13.3.0/bin/gcc
export CXX=nvc++
export CFLAGS="-idirafter $PWD/elja-sysroot/usr/include"
export CXXFLAGS="-std=c++17 -idirafter $PWD/elja-sysroot/usr/include"
